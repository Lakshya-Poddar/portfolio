    ...
    return (
        <div className="navbarcss">
            ...
            <Navbar collapseOnSelect expand="lg" bg={darkmode?"light":"dark"} variant={darkmode?"light":"dark"}>
                    <Navbar.Brand><i className={darkmode?"fa fa-sun-o":"fa fa-moon-o"} onClick={()=>modechange()}></i></Navbar.Brand>
                    <Navbar.Toggle aria-controls="responsive-navbar-nav" />
                            <Navbar.Collapse id="responsive-navbar-nav">
                                    <Nav className="ml-auto">
                                    <Nav.Link className={darkmode?"text-dark linklight":"text-light linkdark"}><Link to='/' className={darkmode?"linkdark":"linklight"}>HOME</Link></Nav.Link>
